...
/*
 * Destinations a marketing flow would actually link to, so the table reads
 * real. Acme is the placeholder the rest of the demo already uses (see the
 * sender addresses in workflow.config.ts) — fixtures should never carry a name
 * that belongs to somebody.
 */
const LINK_POOL = [
  'https://acme.io/',
  'https://acme.io/dashboard',
  'https://acme.io/pricing',
  'https://acme.io/templates',
  'https://acme.io/changelog',
  'https://acme.io/help/getting-started',
